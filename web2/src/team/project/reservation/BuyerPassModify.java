...
public class BuyerPassModify extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				if (passwordChange.equals(jtf1.getText())) {
					if (jtf2.getText().equals(jtf3.getText())) {
						...
						ReservationDao.buyerPassword(id, passwordChange);
					} else {
	...
	public BuyerPassModify(String id,String passwordChange) {
		initLay();
		
		this.passwordChange = passwordChange;
		this.id = id;
		System.out.println(id+"  "+passwordChange);
